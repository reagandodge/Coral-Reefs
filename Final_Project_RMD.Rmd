...
Taking a different look at abundance by island through a bar plot. 
```{r echo=FALSE, out.width = '100%'}
...
**These initial analyses give us a good insight into what this data looks like. We look forward to working further on this data more so that we can determine how a warming climate impacts corals and how variables affect community structure.**
